...
im1 = cv2.imread("paper_blocks.jpg", 0) #Import image as grayscale
...
cv2.createTrackbar("constant", "t", 2, 80, trackbarRes) 
...
while True:
	...
	adaptiveThresh = cv2.adaptiveThreshold(im1, brightness, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, blocksize, constant)
